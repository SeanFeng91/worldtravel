...
// node_modules/markdown-it-emoji/lib/data/light.mjs
var light_default = {
  "grinning": "😀",
  "smiley": "😃",
  "smile": "😄",
...
// node_modules/markdown-it-emoji/lib/light.mjs
function emoji_plugin2(md, options) {
  const defaults = {
    defs: light_default,
...
function emoji_plugin3(md, options) {
  const defaults = {
    defs: full_default,
    shortcuts: shortcuts_default,
    enabled: []
...
export {
  emoji_plugin as bare,
  emoji_plugin3 as full,
  emoji_plugin2 as light
};
