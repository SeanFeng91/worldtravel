...
// node_modules/@orama/wc-components/dist/esm/orama-toggler.entry.js
var v = Object.defineProperty;
var M = Object.getOwnPropertyDescriptor;
var l = (e, h2, p, s2) => {
  for (var t = s2 > 1 ? void 0 : s2 ? M(h2, p) : h2, i = e.length - 1, L; i >= 0; i--)
    (L = e[i]) && (t = (s2 ? L(h2, p, t) : L(t)) || t);
  return s2 && t && v(h2, p, t), t;
};
...
var OramaToggler = class {
  ...
  render() {
    return h(Host, { key: "336089434cc813b53719120cfcd217558f3b9b92" }, h("button", { key: "d23e971f97cd776bd1f87f869be6b343728c7f4f", type: "button", class: {
      selected: globalContext.currentTask === "search",
      animate: !this.firstRender || this.performInitialAnimation
    }, onClick: () => globalContext.currentTask = "search" }, h("span", { key: "796e1f1e6b2720460470f9f625ae0d937623a076" }, "Search"), h("ph-magnifying-glass", { key: "067a47584366af8272ac88b251e85960080012c0", size: 16 })), h("button", { key: "15015243b304ee1c466037b12cd77b4be86068f9", type: "button", class: {
      selected: globalContext.currentTask === "chat",
      animate: !this.firstRender || this.performInitialAnimation
    }, onClick: () => globalContext.currentTask = "chat" }, h("ph-sparkle", { key: "3231a431cb12f913aebbca0d5eb50042cf0cf381", size: 16 }), h("span", { key: "d2c41b105b46c80a8f40aab3126aa27d5111468c" }, "Ask AI")));
  }
};
OramaToggler.style = OramaTogglerStyle0;
export {
  OramaToggler as orama_toggler
};
//# sourceMappingURL=orama-toggler.entry-KIHWLIO2.js.map
