...
// node_modules/@orama/wc-components/dist/esm/PhX-4afc9083.js
var Icon = ({ name, size = 24, color = "black" }) => {
  ...
  return h("div", { innerHTML: getIconSvg(name), style: {
    width: `${size}px`,
    height: `${size}px`,
    fill: color,
...
var o = (a, s2, l, i) => {
  for (var r = i > 1 ? void 0 : i ? u(s2, l) : s2, h2 = a.length - 1, L; h2 >= 0; h2--)
    (L = a[h2]) && (r = (i ? L(s2, l, r) : L(r)) || r);
...
//# sourceMappingURL=chunk-M5WWNCVR.js.map
