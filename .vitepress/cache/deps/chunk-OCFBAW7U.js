// node_modules/@orama/wc-components/dist/esm/property-05c484f6.js
var r = globalThis;
var c$1 = r.ShadowRoot && (r.ShadyCSS === void 0 || r.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
var a$1 = Symbol();
var i$1 = /* @__PURE__ */ new WeakMap();
var l$2 = class {
  constructor(s2, t, o2) {
...
var h$1 = (e) => new l$2(typeof e == "string" ? e : e + "", void 0, a$1);
var p$3 = (e, ...s2) => {
...
var y$3 = c$1 ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((s2) => {
  let t = "";
  for (const o2 of s2.cssRules) t += o2.cssText;
  return h$1(t);
})(e) : e;
var { is: b$2, defineProperty: v$1, getOwnPropertyDescriptor: S$1, getOwnPropertyNames: U$1, getOwnPropertySymbols: w$2, getPrototypeOf: A } = Object;
var a = globalThis;
var f$2 = a.trustedTypes;
var O$2 = f$2 ? f$2.emptyScript : "";
var p$2 = a.reactiveElementPolyfillSupport;
var l$1 = (o2, t) => o2;
var d$1 = { toAttribute(o2, t) {
  switch (t) {
    case Boolean:
      o2 = o2 ? O$2 : null;
      break;
...
var y$2 = (o2, t) => !b$2(o2, t);
var E$1 = { attribute: true, type: String, converter: d$1, reflect: false, hasChanged: y$2 };
...
var y$1 = globalThis;
var S = y$1.trustedTypes;
var I = S ? S.createPolicy("lit-html", { createHTML: (h2) => h2 }) : void 0;
var W = "$lit$";
var p$1 = `lit$${Math.random().toFixed(9).slice(2)}$`;
var k = "?" + p$1;
var F = `<${k}>`;
var v = document;
var x = () => v.createComment("");
var H = (h2) => h2 === null || typeof h2 != "object" && typeof h2 != "function";
var D = Array.isArray;
var Z = (h2) => D(h2) || typeof (h2 == null ? void 0 : h2[Symbol.iterator]) == "function";
var w$1 = `[ 	
\f\r]`;
var m = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g;
var B = /-->/g;
var P$1 = />/g;
var u$1 = RegExp(`>|${w$1}(?:([^\\s"'>=/]+)(${w$1}*=${w$1}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g");
var R = /'/g;
var U = /"/g;
var V = /^(?:script|style|textarea|title)$/i;
var O$1 = (h2) => (t, ...e) => ({ _$litType$: h2, strings: t, values: e });
var Y = O$1(1);
var tt = O$1(2);
var N = Symbol.for("lit-noChange");
var _ = Symbol.for("lit-nothing");
var j = /* @__PURE__ */ new WeakMap();
var g$1 = v.createTreeWalker(v, 129);
function z(h2, t) {
...
var q = (h2, t) => {
  ...
  for (let A2 = 0; A2 < e; A2++) {
    const r2 = h2[A2];
    let a2, $, l2 = -1, c2 = 0;
    for (; c2 < r2.length && (n2.lastIndex = c2, $ = n2.exec(r2), $ !== null); ) c2 = n2.lastIndex, n2 === m ? $[1] === "!--" ? n2 = B : $[1] !== void 0 ? n2 = P$1 : $[2] !== void 0 ? (V.test($[2]) && (i2 = RegExp("</" + $[2], "g")), n2 = u$1) : $[3] !== void 0 && (n2 = u$1) : n2 === u$1 ? $[0] === ">" ? (n2 = i2 != null ? i2 : m, l2 = -1) : $[1] === void 0 ? l2 = -2 : (l2 = n2.lastIndex - $[2].length, a2 = $[1], n2 = $[3] === void 0 ? u$1 : $[3] === '"' ? U : R) : n2 === U || n2 === R ? n2 = u$1 : n2 === B || n2 === P$1 ? n2 = m : (n2 = u$1, i2 = void 0);
    const d2 = n2 === u$1 && h2[A2 + 1].startsWith("/>") ? " " : "";
    o2 += n2 === m ? r2 + F : l2 >= 0 ? (s2.push(a2), r2.slice(0, l2) + W + r2.slice(l2) + p$1 + d2) : r2 + p$1 + (l2 === -2 ? A2 : d2);
  }
...
var T = class _T {
  constructor({ strings: t, _$litType$: e }, s2) {
    ...
    if (this.el = _T.createElement(a2, s2), g$1.currentNode = this.el.content, e === 2) {
      const l2 = this.el.content.firstChild;
      l2.replaceWith(...l2.childNodes);
    }
    for (; (i2 = g$1.nextNode()) !== null && r2.length < A2; ) {
      if (i2.nodeType === 1) {
        if (i2.hasAttributes()) for (const l2 of i2.getAttributeNames()) if (l2.endsWith(W)) {
          const c2 = $[n2++], d2 = i2.getAttribute(l2).split(p$1), C = /([.?@])?(.*)/.exec(c2);
          r2.push({ type: 1, index: o2, name: C[2], strings: d2, ctor: C[1] === "." ? J : C[1] === "?" ? K : C[1] === "@" ? Q : M }), i2.removeAttribute(l2);
        } else l2.startsWith(p$1) && (r2.push({ type: 6, index: o2 }), i2.removeAttribute(l2));
        if (V.test(i2.tagName)) {
          const l2 = i2.textContent.split(p$1), c2 = l2.length - 1;
          if (c2 > 0) {
            i2.textContent = S ? S.emptyScript : "";
            for (let d2 = 0; d2 < c2; d2++) i2.append(l2[d2], x()), g$1.nextNode(), r2.push({ type: 2, index: ++o2 });
            i2.append(l2[c2], x());
          }
        }
        ...
        let l2 = -1;
        for (; (l2 = i2.data.indexOf(p$1, l2 + 1)) !== -1; ) r2.push({ type: 7, index: o2 }), l2 += p$1.length - 1;
      }
      o2++;
    }
  }
...
var b$1 = class _b$1 {
  ...
  k(t) {
    ...
    const e = this._$AH;
    let s2, i2 = 0;
    for (const o2 of t) i2 === e.length ? e.push(s2 = new _b$1(this.S(x()), this.S(x()), this, this.options)) : s2 = e[i2], s2._$AI(o2), i2++;
...
var E = y$1.litHtmlPolyfillSupport;
var L;
...
var d = (e, t, r2) => t in e ? h(e, t, { enumerable: true, configurable: true, writable: true, value: r2 }) : e[t] = r2;
var l = (e, t) => {
  for (var r2 in t || (t = {}))
...
var u = (e, t) => f(e, y(t));
var b = { attribute: true, type: String, converter: d$1, reflect: false, hasChanged: y$2 };
var w = (e = b, t, r2) => {
...
function O(e) {
  return (t, r2) => typeof r2 == "object" ? w(e, t, r2) : ((n2, s2, a2) => {
    ...
    return s2.constructor.createProperty(a2, o2 ? u(l({}, n2), { wrapped: true }) : n2), o2 ? Object.getOwnPropertyDescriptor(s2, a2) : void 0;
  })(e, t, r2);
}
...
@orama/wc-components/dist/esm/property-05c484f6.js:
  (**
   * @license
   ...
   *)
*/
//# sourceMappingURL=chunk-OCFBAW7U.js.map
